...
Working decision log for the RFQ-to-quote prototype. These choices are fixed for the assessment build.

## Selected vs rejected

| Decision | Selected | Rejected |
|----------|----------|----------|
| Problem | P1 RFQ-to-quote (logic-heavy, mocked externals) | Problem 2 |
